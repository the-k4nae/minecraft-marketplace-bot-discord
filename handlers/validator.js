...
import { getDatabase, isBlacklisted, getUserActiveNegotiations, getActiveReservation } from "../utils/database.js"
...
export function validateMoney(raw) {
  ...
  return { valid: true, value: parseFloat(num.toFixed(2)), error: null }
}
